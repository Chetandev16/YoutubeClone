...
const NavBar = () => {
    ...
    return (
        <div className='flex justify-between items-center px-4 lg:px-4 py-[0.5rem] fixed w-full'>
            ...
            <div className={`hidden lg:flex cursor-pointer gap-5 relative`}>

                {/* mobile navbar */}
                <svg onClick={() => {
                    setToggleNav(true)
                }} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 block lg:hidden">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z" />
                </svg>
                ...
                <svg className="absolute hidden lg:block font-bold h-4 w-6 top-[4px] left-[-3px]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                ...
                <img className='w-[24px] hidden lg:block h-[24px] object-cover cursor-pointer rounded-full' src="https://images.pexels.com/photos/220453/pexels-photo-220453.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500" alt="" />
                <div className='absolute hidden lg:block top-[-8px] bg-red-600 rounded-full text-sm left-14'>9+</div>
            </div>
